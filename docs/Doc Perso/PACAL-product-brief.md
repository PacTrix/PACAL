...
- fixation d'une cible de kcal par jour avec alerte au fur et à mesure des prises 
- ajout d'information à la journée
  - Productivité pro et perso
  - temps d'écran
  - étant migraineux : niveau de céphalées
- transformation de l'app d'un mode web app à un mode app native Apple et Android

## Vision

Dans deux ou trois mois, PACAL n'est plus seulement un carnet de prises
...
Si l'expérience est concluante alors présentation de l'app.à 2 ou 3 diététicien et médecin pour envidager une suite plus grand public mais dans le cadre d'une app proposée dans le cadre d"un suivi médical.
