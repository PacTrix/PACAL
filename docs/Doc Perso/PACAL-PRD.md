...
Remarque : la question de l'accès distant et de la confidentialité peut se régler avec l'usage de TailScale, déjà installé et maîtrisé
...
2. Mécanisme précis d'accès distant hors réseau domestique (NFR-2) — VPN,
   ...
   1. Comme indiqué : TailScale sera très bien
